...
");
            ...
            for (int i = 0; i < serializableClasses.Count; i++)
            {
                var publicStaticVoidDonothing = "{public static void DoNothing() {}}";
                sb.Append($"public static class DummySymbol{i} {publicStaticVoidDonothing}");
            ...
            //{
            //    sb.Append(@"namespace MetaJson
            //    {
            //        ");

            //    sb.Append($"public partial class My{DateTime.Now.Minute}{DateTime.Now.Second}");
            //    sb.AppendLine();
            //    sb.Append("{");
            //    sb.AppendLine();
